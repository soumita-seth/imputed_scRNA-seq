...
#data3<-data2.df[,1:100]
#data save in file 
#write.csv(data2.df,file = "tronposedata3.csv", row.names = TRUE)
#read.csv("tronposedata3.csv")
#r<-rownames(data2.df)
#colnames(data2.df)
#data2.df['label1']<-rownames(data2.df)
#data3=read.csv("tronposedata3.csv",header = TRUE,sep=",",check.names=TRUE)
#dim(data3)
#View(data3)
